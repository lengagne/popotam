#ifndef Problem7Torque_H
#define Problem7Torque_H
...
class Problem7Torque : public AbstractCSP
{
    public:
        Problem7Torque(unsigned int n,double X, double Y):AbstractCSP()
        {
			nb_dof_ = n;
            pb_name_ = "2D_Problem7_Torque"+std::to_string(nb_dof_)+"_X"+std::to_string(X)+"_Y"+std::to_string(Y);
            Xt = X;
            Yt = Y;
            get_criteria_ = true;
...
#include "Problem7Torque.hxx"

#endif // Problem7Torque_H
